...
SELECT slot_name FROM pg_create_physical_replication_slot('nonfailover_p', false);
SELECT slot_name FROM pg_create_physical_replication_slot('failover_p', true);
